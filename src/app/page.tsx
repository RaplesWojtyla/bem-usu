		...
		<div className="text-gray-900">
			...
			<div className="px-12 mt-5">
				...
				<section className="text-white py-8 px-4">
					<div className="bg-gradient-to-tr from-[#00633C] to-[#00633C]/65 text-white rounded-xl shadow-md p-24 space-y-8">
						...
						<div className="flex flex-col lg:flex-row justify-between items-center gap-16">
							<div className="max-w-lg text-left">
								...
								<Image src="/img/logo kabinet.png" alt="Logo Kabinet" className="mt-8 ml-16" width={320} height={320} />
							</div>

							<div className="max-w-lg text-left">
								<Image src="/img/bem_usu.png" alt="Logo BEM USU" className="mb-8 ml-24" width={320} height={320} />
								<p className="text-base md:text-lg leading-relaxed">
				...
				{/* Trending News */}
				<section className="text-white py-8 px-4">
					<div className="backdrop-blur-sm bg-white/30 rounded-xl text-black px-24 py-16 shadow-md">
						<div className="flex items-center justify-between">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 mt-12">
							<div className="relative max-w-2xl rounded-xl overflow-hidden hover:scale-105 transition duration-500">
								<Image src="/img/news.png" alt="News 1" className="w-full h-full object-cover " width={600} height={400}/>
							...
							<div className="relative max-w-2xl rounded-xl overflow-hidden hover:scale-105 transition duration-500">
								<Image src="/img/news2.png" alt="News 2" className="w-full h-full object-cover" width={600} height={400}/>
								<div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent p-5 flex flex-col justify-end">
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-16">
							<div className="flex gap-3 items-start hover:bg-green-500 transition duration-300 hover:-translate-y-2 rounded-md group" >
